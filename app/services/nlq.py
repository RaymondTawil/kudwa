...
def nlq(con: Connection, query: str, conversation_id: Optional[str], openai_api_key: Optional[str], default_model_name: str, model_variants_str: str | None = None,prefer_model: str | None = None,) -> Dict[str, Any]:
    """
    ...
    if answer is None:
        if not openai_api_key:
            ...
            try:
                ...
                if prompt_tokens:    AI_TOKENS.labels("prompt", model_used).inc(prompt_tokens)
                if completion_tokens:AI_TOKENS.labels("completion", model_used).inc(completion_tokens)
